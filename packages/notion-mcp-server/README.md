...
```bash
npm install -g @sargonpiraev/notion-mcp-server
```
...
https://github.com/sargonpiraev/packages/tree/main/packages/notion-mcp-server

## Run

```bash
npx @sargonpiraev/notion-mcp-server
```
