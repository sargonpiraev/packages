...
```bash
npm install -g @sargonpiraev/gitlab-mcp-server
```
...
https://github.com/sargonpiraev/packages/tree/main/packages/gitlab-mcp-server

## Run

```bash
npx @sargonpiraev/gitlab-mcp-server
```
